...
$(ELABORATE_FILE_FS): hub.yaml $(TEMPLATE_PARAMS) $(RESTORE_PARAMS_FILE) params/user.yaml cloud.yaml
	$(hub) elaborate \
		hub.yaml cloud.yaml $(TEMPLATE_PARAMS) $(RESTORE_PARAMS_FILE) params/user.yaml \
		$(HUB_OPTS) \
		-o $(ELABORATE_FILES)
